...
//     }
//   },[error,data,updateUserData,isSuccess])
...
const Profile = () => {
  ...
  // Ensure `user` is safely accessed
  ...
  // Always render hooks first; display loading state conditionally
  return (
    <div className="max-w-4xl mx-auto px-4 my-24">
      <h1 className="font-bold text-2xl text-center md:text-left">PROFILE</h1>

      {/* Show loading state without affecting hooks execution */}
      {isLoading ? (
        <h1>Loading...</h1>
      ) : user ? (
        <>
