        ...
        <Card>
          ...
          <CardContent className="space-y-2">
            <div className="space-y-1">
              ...
              <Input type="text" name="name" value={signupInput.name}  onChange={(e)=>changeHandler(e,"signup")} placeholder="Your name" required={true}/>
            </div>
            <div className="space-y-1">
              <Label htmlFor="username">email</Label>
              <Input type="email" name="email" value={signupInput.email} onChange={(e)=>changeHandler(e,"signup")} placeholder="Your email" required={true}/>
            </div>
            <div className="space-y-1">
              <Label htmlFor="username">password</Label>
              <Input type="password" name="password" value={signupInput.password} onChange={(e)=>changeHandler(e,"signup")} placeholder="Your Password" required={true}/>
            </div>
          </CardContent>
          <CardFooter>
        ...
        <Card>
          ...
          <CardContent className="space-y-2">
            <div className="space-y-1">
              ...
              <Input type="email" name="email" onChange={(e)=>changeHandler(e,"login")} value={loginInput.email} placeholder="Your email" required={true}/>
            </div>
            <div className="space-y-1">
